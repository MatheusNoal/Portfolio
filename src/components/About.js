      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen">
          ...
          <motion.div
            ...
            <p className="mb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque, maxime! Necessitatibus accusamus ea iure veritatis itaque ratione, quam inventore animi voluptatem officia aspernatur recusandae et impedit architecto nihil magnam quaerat.</p>
