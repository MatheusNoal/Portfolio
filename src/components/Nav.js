      ...
      <div className="container mx-auto">
        <div className="w-full bg-black/20 h-[96px] backdrop-blur-2x1 rounded-full max-w-[460px] mx-auto px-5 flex justify-between items-center text-2x1 text-white/50">
          <Link
            ...
            spy={true}
            offset={-200}
            className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center hover:scale-110 transition-transform icon-link">
          ...
          <Link
            ...
            spy={true}
            className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center hover:scale-110 transition-transform icon-link">
            <BsClipboardData className="w-7 h-7" />
          </Link>
          <Link
            to="work"
            activeClass="active"
          ...
          <Link
            ...
            spy={true}
            className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center hover:scale-110 transition-transform icon-link">
            <BsChatSquareText className="w-7 h-7" />
          </Link>
        </div>
      </div>
    </nav>
